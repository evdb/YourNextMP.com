...
my $help       = 0;
my $host       = undef;
my $port       = $ENV{MINIFESTO_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive  = 0;
my $restart    = $ENV{MINIFESTO_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background = 0;
my $pidfile    = undef;
...
yournextmp_server.pl - Catalyst Testserver

=head1 SYNOPSIS

yournextmp_server.pl [options]
